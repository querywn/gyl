...
<body>
<s:form action="xsddAction_save.action">
<table id="wrap">
	<tr>
    	<td id="rig_top" >
            ...
            <table class="content" style="font-size:12px;">
                ...
                <tr>
                    ...
                    <td class="inp"><input type="text" name="query_zhub.kpdw" style="text-align:left"/></td>
                    <td style="color:#00F">收货地区</td>
                    <td class="inp"><input type="text" name="query_zhub.shdq" style="text-align:left"/></td>
                    <td style="color:#00F">收货地址</td>
                    <td class="inp"><input type="text" name="query_zhub.shdz" style="text-align:left"/></td>
                </tr>
                <tr>
