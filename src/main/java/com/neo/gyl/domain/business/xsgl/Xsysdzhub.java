...
public class Xsysdzhub implements Serializable{
	private Integer xsysdzhubid;//主键
	private String ddh;
	private String gs;
	...
	private Set<Xsysdzhib> xsysdzhibs = new HashSet<Xsysdzhib>();
	...
	public Integer getXsysdzhubid() {
		return xsysdzhubid;
	}
	public void setXsysdzhubid(Integer xsysdzhubid) {
