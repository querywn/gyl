...
public class Xsfhdzhub implements Serializable{
	private Integer xsfhdzhubid;//主键
	...
	private Set<Xsfhdzhib> xsfhdzhibs = new HashSet<Xsfhdzhib>(); //销售出库单子表
	...
	public Integer getXsfhdzhubid() {
		return xsfhdzhubid;
	}
	public void setXsfhdzhubid(Integer xsfhdzhubid) {
