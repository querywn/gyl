...
public class Xsddzhub implements Serializable {
	...
	private Set<Xsddzhib> xsddzhibs = new HashSet<Xsddzhib>();
	...
	public Integer getXsddzhubid() {
		return xsddzhubid;
	}

	public void setXsddzhubid(Integer xsddzhubid) {
